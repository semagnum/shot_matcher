...
bpy.types.Scene.sm_start_frame = bpy.props.IntProperty(
    default=1)
bpy.types.Scene.sm_end_frame = bpy.props.IntProperty(
    default=250)
bpy.types.Scene.sm_frame_step = bpy.props.IntProperty(
    default=10,
    min=1)
